<h1 align="center" style="color:#6A4BBC; font-weight:600;">🛡️ Omnixys Event Service – Identity & Security Module</h1>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Continuous Integration, Deployment & Security Overview for the <strong>Omnixys Event Service</strong>.
</p>
...
<table align="center" style="border-collapse:collapse;">
  ...
  <tr>
    <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/ci.yaml/badge.svg" alt="Build Status" />
    </td>
    <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/test.yaml/badge.svg" alt="E2E Tests" />
    </td>
  </tr>
  <tr>
    <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/security-scan.yaml/badge.svg" alt="Security Audit" />
    </td>
    <td align="center" style="padding:4px;">
   ...
   <tr>
    <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/release.yaml/badge.svg" alt="Security Audit" />
    </td>
   <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/vulnerability-report.yaml/badge.svg" alt="E2E Tests" />
    </td>
  </tr>
    <tr>
      <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/docker-build.yaml/badge.svg" alt="Build Status" />
    </td>
     <td align="center" style="padding:4px;">
      <img src="https://github.com/omnixys/omnixys-event-service/actions/workflows/deploy.yaml/badge.svg" alt="Build Status" />
    </td>
    </tr>
</table>
...
<table align="center" style="border-collapse:collapse;">
  ...
  <tr>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/last-commit/omnixys/omnixys-event-service?label=Last%20Commit&style=flat-square&color=6A4BBC" alt="Last Commit" />
    </td>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/commit-activity/m/omnixys/omnixys-event-service?style=flat-square&color=6A4BBC" alt="Commit Activity" />
    </td>
  </tr>
  <tr>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/languages/top/omnixys/omnixys-event-service?style=flat-square&color=4E3792" alt="Primary Language" />
    </td>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/languages/code-size/omnixys/omnixys-event-service?style=flat-square&color=4E3792" alt="Code Size" />
    </td>
  </tr>
  <tr>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/issues/omnixys/omnixys-event-service?style=flat-square&color=A3E635" alt="Issues" />
    </td>
    <td align="center" style="padding:4px;">
      <img src="https://img.shields.io/github/issues-pr/omnixys/omnixys-event-service?style=flat-square&color=A3E635" alt="Pull Requests" />
    </td>
  </tr>
  <tr>
    <td align="center" style="padding:4px;">
...
<p align="center" style="font-size:14px; color:#312E81;">
  Overview of the purpose and core functionality of the <strong>Omnixys Event Service</strong>.
</p>

<p>
  The <strong>Omnixys Event Service</strong> is a secure and modular identity management microservice
  that provides <strong>event</strong>, <strong>authorization</strong>, and
...
<ul>
  <li>Centralized event identity and access control (AuthN & AuthZ)</li>
  <li>Distributed token validation between microservices</li>
  <li>Federated event through standardized JWT exchange</li>
...
<ul>
  <li>🔑 <strong>Keycloak-based event management</strong> (OAuth 2.0 / OpenID Connect)</li>
...
<table align="center" style="border-collapse:collapse; font-size:14px;">
  ...
  <tbody>
    ...
    <tr><td>🔐 Event</td><td><strong>Keycloak 25+</strong></td></tr>
...
│   │   ├── test.yml                                # 🧪 E2E Event Tests (Keycloak, Redis, Kafka, Postgres)
...
│   │   ├── event/
│   │   │   ├── event.login.e2e-spec.ts     # Login / Refresh / Logout
│   │   │   ├── event.signup.e2e-spec.ts    # Event & Admin registration (SignUp flow)
│   │   │   ├── event.event.e2e-spec.ts      # Me / Update profile / Change password / Send mail
│   │   │   └── event.admin.e2e-spec.ts     # Admin operations (roles, update, delete)
...
│   ├── event/                              # Event & Keycloak integration layer
...
<p align="center" style="font-size:14px; color:#312E81;">
  The <strong>Omnixys Event Service</strong> relies on a structured set of environment variables to define its
...
<p align="center" style="font-size:14px; color:#312E81;">
  Environment variables that define the <strong>runtime configuration</strong> and <strong>operational behavior</strong> of the Event Service.
</p>
...
<table align="center" style="border-collapse:collapse; font-size:14px;">
  ...
  <tbody>
    <tr><td><code>SERVICE</code></td><td>Logical name of the microservice</td><td><code>event</code></td></tr>
...
<table align="center" style="border-collapse:collapse; font-size:14px;">
  ...
  <tbody>
    ...
    <tr><td><code>OMNIXYS_USER_USERNAME</code></td><td>Standard event username</td><td><code>event</code></td></tr>
    <tr><td><code>OMNIXYS_USER_PASSWORD</code></td><td>Standard event password</td><td><code>change-me</code></td></tr>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Connection parameters for the integrated <strong>Keycloak Identity Provider</strong> – required for event, authorization, and token issuance.
</p>
...
Follow these steps to set up the <strong>Omnixys Event Service</strong> locally or in a containerized environment.
...
git clone https://github.com/omnixys/omnixys-event-service.git
...
<p style="font-size:14px; color:#312E81;">
  ...
  these are the roles that the Event Service uses for access control.
</p>

<h5 style="color:#6A4BBC; margin-bottom:4px;">4️⃣ Create an Admin Event</h5>
<p style="font-size:14px; color:#312E81;">
  Go to <strong>Users</strong> → <strong>Add Event</strong> and fill in the following fields:
</p>
...
<h5 style="color:#6A4BBC; margin-bottom:4px;">5️⃣ Set Event Credentials</h5>
<p style="font-size:14px; color:#312E81;">
...
<h5 style="color:#6A4BBC; margin-bottom:4px;">6️⃣ Assign Roles to the Admin Event</h5>
<p style="font-size:14px; color:#312E81;">
...
<p style="font-size:14px; color:#312E81;">
  Ensure your event now appears with both roles assigned.<br/>
  This admin account will be used by the <strong>Omnixys Event Service</strong> during initialization and token management.
</p>

---

<p style="font-size:14px; color:#312E81;">
  ✅ After completing these steps, Keycloak is fully prepared for integration with the Event Service, Camunda, and other Omnixys modules.
</p>
...
Run the <strong>Omnixys Event Service</strong> in either development or production mode.
...
<p style="font-size:14px; color:#312E81;">
  ...
  These components provide the essential backend services for event, orchestration, monitoring, and event streaming.
</p>
...
<p style="font-size:14px; color:#312E81;">
  The <strong>Kafka advertised hostname</strong> depends on where the Event Service is running.<br/>
...
Example GraphQL mutation for event using the **Omnixys Event Service**:
...
<p align="center">
  Common issues and solutions when running or developing the <strong>Omnixys Event Service</strong>.
</p>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Useful commands for development, testing, and maintaining code quality within the <strong>Omnixys Event Service</strong>.
</p>
...
<p align="center">
  Join the <strong>Omnixys Developer Community</strong> to share ideas, collaborate, and get support for the <strong>Event Service</strong>.
</p>
...
<table align="center" style="border-collapse:collapse; font-size:14px;">
  ...
  <tbody>
    <tr><td>💡 <strong>Propose a Feature</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=ideas--suggestions" style="color:#6A4BBC;">Start a Feature Discussion</a></td></tr>
    <tr><td>🧪 <strong>Discuss Implementation Details</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=implementation-details" style="color:#6A4BBC;">Join an Architecture Thread</a></td></tr>
    <tr><td>❓ <strong>Ask a Question or Get Support</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=questions--support" style="color:#6A4BBC;">Open a Question</a></td></tr>
    <tr><td>🧵 <strong>General Feedback / Meta</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=general" style="color:#6A4BBC;">Start a General Discussion</a></td></tr>
    <tr><td>🐛 <strong>Report a Bug</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/issues/new?template=auth_bug_report.yml" style="color:#6A4BBC;">Create a Bug Report</a></td></tr>
    <tr><td>🔒 <strong>Report a Security Issue</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/security/policy" style="color:#6A4BBC;">Submit Security Report</a></td></tr>
    <tr><td>🆘 <strong>Need Help with Setup?</strong></td><td><a href="https://github.com/omnixys/omnixys-event-service/issues/new?template=auth_support_request.yml" style="color:#6A4BBC;">Use the Support Template</a></td></tr>
  </tbody>
</table>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Follow these steps to contribute to the <strong>Omnixys Event Service</strong>:
</p>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Überblick über den Zweck und die Kernfunktionen des <strong>Omnixys Event Service</strong>.
</p>

<p>
  Der <strong>Omnixys Event Service</strong> ist ein sicherer und modularer Identitäts-Mikroservice,
...
<p>
  Der <strong>Omnixys Event Service</strong> basiert auf einer modernen, skalierbaren Architektur und setzt auf folgende Technologien:
</p>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Folge diesen Schritten, um den <strong>Omnixys Event Service</strong> lokal oder in einer Container-Umgebung zu installieren.
</p>
...
<p style="font-size:14px; color:#312E81;">
  ...
  Diese Rollen werden vom Event Service für die Zugriffskontrolle verwendet.
</p>

<h5 style="color:#6A4BBC; margin-bottom:4px;">4️⃣ Administrator-Benutzer anlegen</h5>
<p style="font-size:14px; color:#312E81;">
  In der Seitenleiste <strong>Users</strong> öffnen → <strong>Add Event</strong> auswählen und ausfüllen:
</p>
...
<p style="font-size:14px; color:#312E81;">
  ...
  Dieses Admin-Konto wird vom <strong>Omnixys Event Service</strong> für Authentifizierung und Token-Verwaltung genutzt.
</p>

---

<p style="font-size:14px; color:#312E81;">
  ✅ Nach Abschluss dieser Schritte ist Keycloak vollständig für die Integration mit dem Event Service, Camunda und anderen Omnixys-Modulen vorbereitet.
</p>
...
Starte den <strong>Omnixys Event Service</strong> wahlweise im Entwicklungs- oder Produktionsmodus.
...
<p style="font-size:14px; color:#312E81;">
  Der <strong>beworbene Kafka-Hostname</strong> hängt davon ab, wo der Event-Service läuft.<br/>
...
<p align="center" style="font-size:14px; color:#312E81;">
  ...
  <strong>Omnixys Event Service</strong>:
</p>
...
<p align="center" style="font-size:14px; color:#312E81;">
  Häufige Probleme und deren Lösungen beim Entwickeln oder Ausführen des <strong>Omnixys Event Service</strong>.
</p>
...
<p align="center" style="font-size:14px; color:#312E81;">
  ...
  <strong>Event Service</strong> zu erhalten.
</p>
...
<table align="center" style="border-collapse:collapse; font-size:14px;">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=ideas--suggestions" style="color:#6A4BBC; text-decoration:none;">Neue Funktionsdiskussion starten</a></td>
    </tr>
    <tr>
      <td>🧪 <strong>Implementierungsdetails diskutieren</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=implementation-details" style="color:#6A4BBC; text-decoration:none;">Architektur-Thread beitreten</a></td>
    </tr>
    <tr>
      <td>❓ <strong>Fragen oder Hilfe anfordern</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=questions--support" style="color:#6A4BBC; text-decoration:none;">Neue Frage stellen</a></td>
    </tr>
    <tr>
      <td>🧵 <strong>Allgemeines Feedback / Meta</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/discussions/new?category=general" style="color:#6A4BBC; text-decoration:none;">Allgemeine Diskussion starten</a></td>
    </tr>
    <tr>
      <td>🐛 <strong>Fehler melden</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/issues/new?template=auth_bug_report.yml" style="color:#6A4BBC; text-decoration:none;">Bug Report erstellen</a></td>
    </tr>
    <tr>
      <td>🔒 <strong>Sicherheitsproblem melden</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/security/policy" style="color:#6A4BBC; text-decoration:none;">Sicherheitsbericht einreichen</a></td>
    </tr>
    <tr>
      <td>🆘 <strong>Hilfe beim Setup</strong></td>
      <td><a href="https://github.com/omnixys/omnixys-event-service/issues/new?template=auth_support_request.yml" style="color:#6A4BBC; text-decoration:none;">Support-Vorlage verwenden</a></td>
    </tr>
  </tbody>
</table>
...
<p align="center" style="font-size:14px; color:#312E81;">
  So kannst du aktiv zum <strong>Omnixys Event Service</strong> beitragen:
</p>
